...
$fields = [
    ...
    'product_image' => $product_name, // Replace with actual product image name
];
...
$file = $root_dir.$file;
if (file_exists($file)) {
    header('Content-Type: 'Content-Type: image/png'); // Change to the appropriate content type
...
// Do something with the response or handle it accordingly
